...
// constructor takes 3 parameters, name, status, pictureUrl / or drawableId
// remember to give internet permission in manifest file
data class UserProfile constructor (
    val id: Int,
    val name: String,
    val status: Boolean, // passed to @Composable ProfilePicture
    val pictureUrl: String // passed to @Composable ProfilePicture / could also be drawableId
    )
